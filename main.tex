			...
			\begin{threeparttable}[h]
				\begin{table}[H]
					...
					\begin{tabular}{p{4zw}|p{5zw}|Wc{3zw}|p{10zw}|p{10zw}}
						\hline
						{\bf 時刻} \tnote{*}  & {\bf 試合番号}            & \multicolumn{1}{l|}{{\bf Ch.}}  & {\bf Team 1}  & {\bf Team 2}  \\ \hline
						10:00 -               & SF-1A                     & A                               & GroupA 1st    & GroupB 2nd    \\ \hline
						11:20 -               & SF-1B                     & B                               & GroupB 1st    & GroupA 2nd    \\ \hline
						                      & \multicolumn{4}{c}{休憩}                                                                    \\ \hline
						13:20 -               & GF-1A                     & A                               & 未定          & 未定          \\ \hline
						14:40 -               & GF-2A                     & A                               & 未定          & 未定          \\ \hline
						16:00 -               & GF-3A                     & A                               & 未定          & 未定          \\ \hline
					\end{tabular}
				\end{table}
				\begin{tablenotes}
					\item[*] 時刻は試合状況に応じて変更される可能性があります
