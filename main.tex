	        ...
	        \begin{threeparttable}[h]
	            \begin{table}[H]
	                ...
	                \begin{tabular}{p{4zw}|p{5zw}|Wc{3zw}|p{10zw}|p{10zw}}
	                    \hline
	                    {\bf 時刻} \tnote{*}      & {\bf 試合番号}            & \multicolumn{1}{l|}{{\bf Ch.}}  & {\bf Team 1}    & {\bf Team 2}		\\ \hline
	                    \multirow{1}{*}{10:00 -}  & SF-1A                     & A                               & GroupA 1st	& GroupB 2nd	\\ \cline{2-5}
	                    \multirow{1}{*}{11:20 -}  & SF-1B                     & B                               & GroupB 1st	& GroupA 2nd  	\\ \cline{2-5}
	                                              & \multicolumn{4}{c}{休憩}                                                                              \\ \hline
	                    \multirow{1}{*}{13:20 -}  & GF-1A                    & A                               & TBD            	& TBD           \\ \cline{2-5}
	                    \multirow{1}{*}{14:40 -}  & 〃			& 〃                               & 〃            	& 〃  		\\ \cline{2-5}
	                    \multirow{1}{*}{16:00 -}  & 〃			& 〃                               & 〃			& 〃             \\ \cline
	                \end{tabular}
	            \end{table}
	            \begin{tablenotes}
	                \item[*] 時刻は試合状況に応じて変更される可能性があります
